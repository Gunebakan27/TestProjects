...
public class PriceForOneLaptop {
    ...
    public int getPrice(int laptopID){
		...
		Data data=new Data();
    	int totalAmount=0; 	
    	totalAmount+=calculate.getRam(data.AllData(laptopID));
    	totalAmount+=calculate.getCpu(data.AllData(laptopID));
    	totalAmount+=calculate.getSize(data.AllData(laptopID));
    	totalAmount+=calculate.getColor(data.AllData(laptopID));
        return totalAmount;
    }
