...
public class Ex02 {
    ...
    public static void main(String[] args) {
    	...
    	list1=arrayCreate(10, 0, 20);
    	System.out.println("Liste 1 : "+list1);
    	ArrayList<Integer>list2=new ArrayList<>();
    	list2=arrayCreate(5, 0, 20);
    	System.out.println("Liste 2 : "+list2);
    	
    	ArrayList<Integer>listOrtak=new ArrayList<>(list1);   	
    	listOrtak.retainAll(list2);
    	System.out.println("Ortak Elemanlar : " + listOrtak);
    	
    	ArrayList<Integer>listFark=new ArrayList<>(list1);
    	listFark.addAll(list2);
    	listFark.removeAll(listOrtak);
    	System.out.println("Farkli Elamanlar : "+listFark);
   
    	list2.addAll(list1);
    	System.out.println("Listeler birlesimi : "+list2);
    	Collections.sort(list2);
    	System.out.println("Kücükten büyüge : "+list2);
    	Collections.reverse(list2);
    	System.out.println("Büyükten kücüge : "+list2);
    }

	public static ArrayList<Integer> arrayCreate(int size, int min, int max) {	
